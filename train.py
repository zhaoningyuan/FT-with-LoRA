...
os.environ["TORCH_NCCL_HEARTBEAT_TIMEOUT_SEC"] = "600"  # Increase the timeout to 600 seconds
...
class DataTrainingArguments:
    ...
    train_examples_num: Optional[int] = field(
        default=10000,
        metadata={"help": "Number of training examples to use."},
    )
    valid_examples_num: Optional[int] = field(
        default=1000,
        metadata={"help": "Number of validation examples to use."},
    )
...
def main(model_args, data_args, training_args):
    ...
    # )
    train_dataset, valid_dataset = my_create_datasets(
        tokenizer,
        data_args,
        training_args,
        apply_chat_template=model_args.chat_template_format != "none",
